      ...
      <Row className="mb-4">
        ...
        <Col md={2}>
          <Card className="border-0 shadow-sm text-center">
            <Card.Body>
              <div style={{ fontSize: '2rem' }}>💰</div>
              <h4 className="text-success">₦{stats.totalRevenue.toLocaleString()}</h4>
                ...
                {filteredOrders.map((order) => (
                  <tr key={order.id}>
                    ...
                    <td>
                      ...
                      <small className="text-muted">{order.farmerPhone}</small>
                    </td>
            ...
            <div>
              <Row>
                ...
                <Col md={6}>
                  ...
                  <p><strong>Price per unit:</strong> ₦{selectedOrder.pricePerUnit?.toLocaleString()}</p>
