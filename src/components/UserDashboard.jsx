            ...
            <div className="col-12">
              <div className="text-center">
                ...
                <p className="lead text-muted">
                  Track your orders and discover fresh farm products
                </p>
              </div>
            </div>
          </div>
            ...
            <Col md={3}>
              <Card className="border-0 shadow-sm bg-success text-white h-100">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-3">
                    Discover fresh farm produce from verified farmers
                  </p>
                  <Button
            ...
            <Col md={3}>
              <Card className="border-0 shadow-sm bg-primary text-white h-100">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-3">
                    Join our marketplace and sell your farm products
                  </p>
                  <Button
                    variant="outline-light"
                    onClick={() => {
                      alert(
                        "Coming Soon! Farmer registration will be available in the next update. Contact support for more information."
                      );
                    }}
                  >
                    Join As Farmer
                          ...
                          <tr key={order.id}>
                            ...
                            <td>
                              ...
                              <small className="text-muted">
                                {order.quantity} {order.unit} from{" "}
                                {order.farmerName}
                              </small>
                            </td>
                  ...
                  <div className="text-center mb-3">
                    ...
                    <div className="position-relative d-inline-block mb-3">
                      {user?.profileImage ? (
                        ...
                        <div
                          className="rounded-circle bg-primary bg-opacity-10 border border-3 border-primary d-flex align-items-center justify-content-center"
                          style={{
                            width: "80px",
                            height: "80px",
                          }}
              ...
              <Card className="border-0 shadow-sm">
                ...
                <Card.Body>
                  <div className="mb-3">
                    ...
                    <small>
                      Order vegetables early in the week for the freshest
                      produce!
                    </small>
                  </div>
                  <div className="mb-3">
                    ...
                    <small>
                      Follow your favorite farmers for exclusive deals and
                      seasonal offers.
                    </small>
                  </div>
                  <div>
