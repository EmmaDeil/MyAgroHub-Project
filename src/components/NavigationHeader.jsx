...
const NavigationHeader = ({
  ...
  return (
    <div style={{ position: "relative", zIndex: 1030 }}>
      <Navbar
        expand="lg"
        className="navbar-dark shadow-sm mb-4"
        style={{
            ...
            <Nav className="me-auto">
              ...
              {!user && (
                <>
                  ...
                  <Nav.Item>
                    <button
                      className={`nav-link btn btn-link text-white border-0 ${
                        currentPage === "home" ? "fw-bold" : ""
                      }`}
                      onClick={() => setCurrentPage("home")}
                      style={
                        currentPage === "home" ? activeNavStyle : navLinkStyle
                      }
                    >
                  ...
                  <Nav.Item>
                    <button
                      className={`nav-link btn btn-link text-white border-0 ${
                        currentPage === "about" ? "fw-bold" : ""
                      }`}
                      onClick={() => setCurrentPage("about")}
                      style={
                        currentPage === "about" ? activeNavStyle : navLinkStyle
                      }
                    >
              ...
              {user && (
                <>
                  ...
                  <Nav.Item>
                    <button
                      className={`nav-link btn btn-link text-white border-0 position-relative ${
                        currentPage === "cart" ? "fw-bold" : ""
                      }`}
                      onClick={() => setCurrentPage("cart")}
                      style={
                        currentPage === "cart" ? activeNavStyle : navLinkStyle
                      }
                    >
                  ...
                  <Nav.Item>
                    <button
                      className={`nav-link btn btn-link text-white border-0 position-relative ${
                        currentPage === "orders" ? "fw-bold" : ""
                      }`}
                      onClick={() => setCurrentPage("orders")}
                      style={
                        currentPage === "orders" ? activeNavStyle : navLinkStyle
                      }
                    >
                ...
                <>
                  ...
                  <Dropdown align="end" drop="down" autoClose="outside">
                    ...
                    >
                      <div className="d-flex align-items-center">
                        <div
                          className="rounded-circle bg-white bg-opacity-25 p-1 me-2"
                          style={{
                            width: "36px",
                            height: "36px",
                            display: "flex",
                        ...
                        <i
                          className="fas fa-chevron-down ms-2 text-white-50"
